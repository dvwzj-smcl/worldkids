<!-- HEADER
	================================================== -->
<header class="header-type-5 header-type-4 header-type-55">
				...
				<div class="pattern">
					<div class="container">
						<div class="row">
							...
							<!-- Header Left -->
							<div class="col-sm-2" id="header-left" style="min-width: <?php echo $image_size[0]+55; ?>px">
								<!-- Logo -->
							...
							<!-- Header Left -->
							<div class="col-sm-10 text-right" id="header-right">
								<div class="row">
									<div id="semi-upmost" class="col-sm-12">
										<?php
									...
									<div id="menu-55" class="col-sm-12">
										<?php
											$menu = $modules->getModules('menu');
										if( count($menu) ) { ?>
										<div class="megamenu-background 555">
											<div class="">
