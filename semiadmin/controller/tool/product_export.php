...
class ControllerToolProductexport extends Controller {
	...
	public function export(){
		...
		$objPHPExcel->getActiveSheet()->setCellValue('AK'.$i, 'Weight Class')->getColumnDimension('AJ')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AL'.$i, 'Status')->getColumnDimension('AK')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AM'.$i, 'Sort Order')->getColumnDimension('AL')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AN'.$i, 'Manufacturer ID')->getColumnDimension('AM')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AO'.$i, 'Manufacturer')->getColumnDimension('AN')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AP'.$i, 'Category ids')->getColumnDimension('AO')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AQ'.$i, 'Categories')->getColumnDimension('AP')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AR'.$i, 'Filters (Filter Group :: filter Value)')->getColumnDimension('AQ')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AS'.$i, 'Download')->getColumnDimension('AR')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AT'.$i, 'Related Products')->getColumnDimension('AS')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AU'.$i, 'Attributes (attribute_Group::attribute::text)')->getColumnDimension('AT')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AV'.$i, 'Options (Option::Type::optionvalue-qty-subtract-price-points-weight
)')->getColumnDimension('AU')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AW'.$i, 'Discount (Customer Group id::Quantity::Priority::Price::startdate::Enddate)')->getColumnDimension('AW')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AX'.$i, 'Special (Customer_group_id::Priority::Price::startdate::Enddate)')->getColumnDimension('AX')->setAutoSize(true);
		$objPHPExcel->getActiveSheet()->setCellValue('AY'.$i, 'Sub Images (image1,image2)')->getColumnDimension('AY')->setAutoSize(true);
		...
		foreach($products as $product){
			...
			$objPHPExcel->getActiveSheet()->setCellValue('AW'.$i, implode(', ',$discounts));
			...
			$objPHPExcel->getActiveSheet()->setCellValue('AX'.$i, implode(', ',$specials));
			...
			$objPHPExcel->getActiveSheet()->setCellValue('AY'.$i, implode(', ',$images));
		}
